...
function StepTemplate({step, children, ЧубзикПик = Чубзик6}: {step: number, setStep: Dispatch<SetStateAction<number>>, children?: ReactNode, ЧубзикПик?: string}) {
...
export default function DialogPage() {
  ...
  const steps = [
    ...
    <StepTemplate ЧубзикПик={Чубзик6} step={step} setStep={setStep}>
      ...
      <p style={{gridArea: "13 / 24 / span 10 / span 18", userSelect: "none", fontSize: "26px"}}>Не забудьте проверить заметки!</p>
    </StepTemplate>,
  ]
  return (
